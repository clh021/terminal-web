...
var file_shell_proto_rawDesc = []byte{
	...
	0x79, 0x32, 0x9f, 0x02, 0x0a, 0x0c, 0x53, 0x68, 0x65, 0x6c, 0x6c, 0x53, 0x65, 0x72, 0x76, 0x69,
	...
	0x67, 0x30, 0x01, 0x12, 0x5e, 0x0a, 0x04, 0x52, 0x75, 0x6e, 0x32, 0x12, 0x2a, 0x2e, 0x6c, 0x6e,
	0x6b, 0x73, 0x5f, 0x68, 0x6f, 0x6d, 0x65, 0x63, 0x6c, 0x6f, 0x75, 0x64, 0x2e, 0x63, 0x6c, 0x68,
	0x30, 0x32, 0x31, 0x2e, 0x77, 0x65, 0x62, 0x73, 0x68, 0x65, 0x6c, 0x6c, 0x2e, 0x43, 0x6d, 0x64,
	0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x1a, 0x26, 0x2e, 0x6c, 0x6e, 0x6b, 0x73, 0x5f, 0x68,
	0x6f, 0x6d, 0x65, 0x63, 0x6c, 0x6f, 0x75, 0x64, 0x2e, 0x63, 0x6c, 0x68, 0x30, 0x32, 0x31, 0x2e,
	0x77, 0x65, 0x62, 0x73, 0x68, 0x65, 0x6c, 0x6c, 0x2e, 0x4f, 0x75, 0x74, 0x70, 0x75, 0x74, 0x28,
...
var file_shell_proto_depIdxs = []int32{
	...
	1, // 2: lnks_homecloud.clh021.webshell.ShellService.Run2:input_type -> lnks_homecloud.clh021.webshell.CmdRequest
	...
	2, // 5: lnks_homecloud.clh021.webshell.ShellService.Run2:output_type -> lnks_homecloud.clh021.webshell.Output
...
type ShellServiceClient interface {
	...
	Run2(ctx context.Context, opts ...grpc.CallOption) (ShellService_Run2Client, error)
}
...
func (c *shellServiceClient) Run2(ctx context.Context, opts ...grpc.CallOption) (ShellService_Run2Client, error) {
	stream, err := c.cc.NewStream(ctx, &_ShellService_serviceDesc.Streams[2], "/lnks_homecloud.clh021.webshell.ShellService/Run2", opts...)
	if err != nil {
		return nil, err
	}
	x := &shellServiceRun2Client{stream}
	return x, nil
}

type ShellService_Run2Client interface {
	Send(*CmdRequest) error
	Recv() (*Output, error)
	grpc.ClientStream
}

type shellServiceRun2Client struct {
	grpc.ClientStream
}

func (x *shellServiceRun2Client) Send(m *CmdRequest) error {
	return x.ClientStream.SendMsg(m)
}

func (x *shellServiceRun2Client) Recv() (*Output, error) {
	m := new(Output)
	if err := x.ClientStream.RecvMsg(m); err != nil {
		return nil, err
	}
...
type ShellServiceServer interface {
	...
	Run2(ShellService_Run2Server) error
}
...
func (*UnimplementedShellServiceServer) Run2(ShellService_Run2Server) error {
...
func _ShellService_Run2_Handler(srv interface{}, stream grpc.ServerStream) error {
	return srv.(ShellServiceServer).Run2(&shellServiceRun2Server{stream})
}

type ShellService_Run2Server interface {
	Send(*Output) error
	Recv() (*CmdRequest, error)
	grpc.ServerStream
}

type shellServiceRun2Server struct {
	grpc.ServerStream
}

func (x *shellServiceRun2Server) Send(m *Output) error {
	return x.ServerStream.SendMsg(m)
}

func (x *shellServiceRun2Server) Recv() (*CmdRequest, error) {
	m := new(CmdRequest)
	if err := x.ServerStream.RecvMsg(m); err != nil {
		return nil, err
	}
...
var _ShellService_serviceDesc = grpc.ServiceDesc{
	...
	Streams: []grpc.StreamDesc{
		...
		{
			StreamName:    "Run2",
			Handler:       _ShellService_Run2_Handler,
			ServerStreams: true,
			ClientStreams: true,
		},
	},
